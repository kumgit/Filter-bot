...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/tamilnew_movieschat')
            ],
            [
                InlineKeyboardButton('⚡ JOIN ⚡', url=f"https://t.me/tamilnew_movieschat"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ JOIN ⚡', url='https://t.me/ContenTeam'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/ContenTeam')
            ],[
